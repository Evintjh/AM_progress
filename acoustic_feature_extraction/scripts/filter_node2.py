...
class FilterNode:
    ...
    def __init__(self):
            ...
            self._max_freq = rospy.get_param('~max_freq', 500)							#this is how he get the frequencies using rospy
    ...
    def _audio_cb(self, msg):
            ...
            audio_data_fft[0 : self._min_freq_scaled] = 0					#2D array, freq and decibels
            audio_data_fft[self._min_freq_scaled : 80] = 0
            audio_data_fft[80 : 160 - self._max_freq_scaled] = 0					#only need 4 bands, and these are the frequency ranges so juz use them
